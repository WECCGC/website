...
var gfeedfetcher_loading_image="ajax-loader.gif"
...
gfeedfetcher._formatdate=function(datestr, showoptions){
	...
	return "<span class='datefield'><br>"+parseddate+"</span>"
}
...
gfeedfetcher.prototype._displayresult=function(feeds){
	...
	for (var i=0; i<feeds.length; i++){
		var itemtitle="<a rel=\"nofollow\" href=\"" + feeds[i].link + "\" target=\"" + this.linktarget + "\" class=\"titlefield\">" + feeds[i].title + "</a><br />"
		...
		rssoutput+=this.itemcontainer + itemtitle + " " + itemlabel + " " + itemdate + "<br />" + itemdescription + this.itemcontainer.replace("<", "</") + "\n\n"
	}
